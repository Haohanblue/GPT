...
os.environ["ZHIPUAI_API_KEY"] = "3b9892afa93ed95c01c62e34e244d1ea.hxyr2FYltUR09i83"
...
# #创建查询引擎
df = pd.read_csv('data/labeldata.csv')
...
#创建agent
agent = ReActAgent.from_tools(query_engine_tools,llm=llm,verbose=True,propmt=prompt)
template = """
忘记之前的所有指令。
